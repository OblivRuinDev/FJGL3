...
/** Wraps an {@code XrPlaneDetectorEXT} handle. */
public class XrPlaneDetectorEXT extends DispatchableHandle {

    private final XrSession session;

    /**
     * Creates an {@code XrPlaneDetectorEXT} using the specified native handle and {@code XrSession}.
     *
     * @param handle  the native {@code XrPlaneDetectorEXT} handle
     * @param session the {@code XrSession} from which {@code handle} was created
     */
    public XrPlaneDetectorEXT(long handle, XrSession session) {
