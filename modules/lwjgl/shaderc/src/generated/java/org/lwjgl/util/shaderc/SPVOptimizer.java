...
public class SPVOptimizer {
    ...
    private static final SharedLibrary SHADERC = Library.loadNative(SPVOptimizer.class, "dev.oblivruin.fjgl.shaderc", Configuration.SPIRV_TOOLS_OPTIMIZER_LIBRARY_NAME, Shaderc::getLibrary);
