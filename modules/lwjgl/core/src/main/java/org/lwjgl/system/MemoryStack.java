...
public class MemoryStack extends Pointer.Default implements StackAllocator<MemoryStack>, AutoCloseable {
    ...
    public ShortBuffer mallocShort(int size) { return wrapBufferShort(nmalloc(2, size << 1), size); }
    ...
    public LongBuffer mallocLong(int size) { return wrapBufferLong(nmalloc(8, size << 3), size); }
    ...
    public DoubleBuffer mallocDouble(int size) { return wrapBufferDouble(nmalloc(8, size << 3), size); }
