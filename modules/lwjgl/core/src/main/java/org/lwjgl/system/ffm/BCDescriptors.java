...
final class BCDescriptors {
    ...
    static final ClassDesc
        ...
        CD_Group                    = Group.class.describeConstable().orElseThrow(),
        ...
        CD_MemoryStack              = MemoryStack.class.describeConstable().orElseThrow(),
    ...
    static final MethodTypeDesc
        ...
        MTD_Group                                              = MethodTypeDesc.of(CD_Group),
        MTD_Group_Group                                        = MethodTypeDesc.of(CD_Group, CD_Group),
        MTD_Group_MemorySegment                                = MethodTypeDesc.of(CD_Group, CD_MemorySegment),
        MTD_Group_MemorySegment_long                           = MethodTypeDesc.of(CD_Group, CD_MemorySegment, CD_long),
        ...
        MTD_Object                                             = MethodTypeDesc.of(CD_Object),
        ...
        MTD_MemoryStack                                        = MethodTypeDesc.of(CD_MemoryStack),
