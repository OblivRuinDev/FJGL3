...
public class AIFileIO extends Struct<AIFileIO> implements NativeResource {
    ...
    public static AIFileIO malloc() {
        return new AIFileIO(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<AIFileIO, Buffer> implements NativeResource {
         ...
         * by {@link AIFileIO#SIZEOF}, and its mark will be undefined.</p>
         *
