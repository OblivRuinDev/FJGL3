...
public class CLDeviceIntegerDotProductAccelerationPropertiesKHR extends Struct<CLDeviceIntegerDotProductAccelerationPropertiesKHR> implements NativeResource {
    ...
    public CLDeviceIntegerDotProductAccelerationPropertiesKHR(long address, @Nullable ByteBuffer container) {
    ...
    public static class Buffer extends StructBuffer<CLDeviceIntegerDotProductAccelerationPropertiesKHR, Buffer> implements NativeResource {
         ...
         * by {@link CLDeviceIntegerDotProductAccelerationPropertiesKHR#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        public Class<?> getElementClass() {
            return CLDeviceIntegerDotProductAccelerationPropertiesKHR.class;
        }
