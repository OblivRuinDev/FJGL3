...
public class SPNG {
    ...
    public static final int
        SPNG_VERSION_MAJOR = 0,
        SPNG_VERSION_MINOR = 7,
        SPNG_VERSION_PATCH = 4;
    ...
    /** {@code spng_ctx * spng_ctx_new2(struct spng_alloc * alloc, int flags)} */
    public static native long nspng_ctx_new2(long alloc, int flags);

    /** {@code spng_ctx * spng_ctx_new2(struct spng_alloc * alloc, int flags)} */
    @NativeType("spng_ctx *")
    public static long spng_ctx_new2(@NativeType("struct spng_alloc *") spng_alloc alloc, int flags) {
    ...
    /** {@code int spng_set_png_stream(spng_ctx * ctx, spng_rw_fn * rw_func, void * user)} */
    public static int spng_set_png_stream(@NativeType("spng_ctx *") long ctx, @NativeType("spng_rw_fn *") spng_rw_fnI rw_func, @NativeType("void *") long user) {
        if (CHECKS) {
            check(ctx);
        }
        return nspng_set_png_stream(ctx, rw_func.address(), user);
    }
    ...
    /** {@code int spng_set_option(spng_ctx * ctx, enum spng_option option, int value)} */
    public static native int nspng_set_option(long ctx, int option, int value);

    /** {@code int spng_set_option(spng_ctx * ctx, enum spng_option option, int value)} */
    public static int spng_set_option(@NativeType("spng_ctx *") long ctx, @NativeType("enum spng_option") int option, int value) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_option(spng_ctx * ctx, enum spng_option option, int * value)} */
    public static native int nspng_get_option(long ctx, int option, long value);

    /** {@code int spng_get_option(spng_ctx * ctx, enum spng_option option, int * value)} */
    public static int spng_get_option(@NativeType("spng_ctx *") long ctx, @NativeType("enum spng_option") int option, @NativeType("int *") IntBuffer value) {
        if (CHECKS) {
            check(ctx);
            check(value, 1);
        }
    ...
    /** {@code int spng_get_row_info(spng_ctx * ctx, struct spng_row_info * row_info)} */
    public static native int nspng_get_row_info(long ctx, long row_info);

    /** {@code int spng_get_row_info(spng_ctx * ctx, struct spng_row_info * row_info)} */
    public static int spng_get_row_info(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_row_info *") spng_row_info row_info) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_ihdr(spng_ctx * ctx, struct spng_ihdr * ihdr)} */
    public static native int nspng_get_ihdr(long ctx, long ihdr);

    /** {@code int spng_get_ihdr(spng_ctx * ctx, struct spng_ihdr * ihdr)} */
    public static int spng_get_ihdr(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_ihdr *") spng_ihdr ihdr) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_plte(spng_ctx * ctx, struct spng_plte * plte)} */
    public static native int nspng_get_plte(long ctx, long plte);

    /** {@code int spng_get_plte(spng_ctx * ctx, struct spng_plte * plte)} */
    public static int spng_get_plte(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_plte *") spng_plte plte) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_trns(spng_ctx * ctx, struct spng_trns * trns)} */
    public static native int nspng_get_trns(long ctx, long trns);

    /** {@code int spng_get_trns(spng_ctx * ctx, struct spng_trns * trns)} */
    public static int spng_get_trns(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_trns *") spng_trns trns) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_chrm(spng_ctx * ctx, struct spng_chrm * chrm)} */
    public static native int nspng_get_chrm(long ctx, long chrm);

    /** {@code int spng_get_chrm(spng_ctx * ctx, struct spng_chrm * chrm)} */
    public static int spng_get_chrm(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_chrm *") spng_chrm chrm) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_chrm_int(spng_ctx * ctx, struct spng_chrm_int * chrm_int)} */
    public static native int nspng_get_chrm_int(long ctx, long chrm_int);

    /** {@code int spng_get_chrm_int(spng_ctx * ctx, struct spng_chrm_int * chrm_int)} */
    public static int spng_get_chrm_int(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_chrm_int *") spng_chrm_int chrm_int) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_iccp(spng_ctx * ctx, struct spng_iccp * iccp)} */
    public static native int nspng_get_iccp(long ctx, long iccp);

    /** {@code int spng_get_iccp(spng_ctx * ctx, struct spng_iccp * iccp)} */
    public static int spng_get_iccp(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_iccp *") spng_iccp iccp) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_sbit(spng_ctx * ctx, struct spng_sbit * sbit)} */
    public static native int nspng_get_sbit(long ctx, long sbit);

    /** {@code int spng_get_sbit(spng_ctx * ctx, struct spng_sbit * sbit)} */
    public static int spng_get_sbit(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_sbit *") spng_sbit sbit) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_text(spng_ctx * ctx, struct spng_text * text, uint32_t * n_text)} */
    public static native int nspng_get_text(long ctx, long text, long n_text);

    /** {@code int spng_get_text(spng_ctx * ctx, struct spng_text * text, uint32_t * n_text)} */
    public static int spng_get_text(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_text *") spng_text text, @NativeType("uint32_t *") IntBuffer n_text) {
        if (CHECKS) {
            check(ctx);
            check(n_text, 1);
        }
    ...
    /** {@code int spng_get_bkgd(spng_ctx * ctx, struct spng_bkgd * bkgd)} */
    public static native int nspng_get_bkgd(long ctx, long bkgd);

    /** {@code int spng_get_bkgd(spng_ctx * ctx, struct spng_bkgd * bkgd)} */
    public static int spng_get_bkgd(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_bkgd *") spng_bkgd bkgd) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_hist(spng_ctx * ctx, struct spng_hist * hist)} */
    public static native int nspng_get_hist(long ctx, long hist);

    /** {@code int spng_get_hist(spng_ctx * ctx, struct spng_hist * hist)} */
    public static int spng_get_hist(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_hist *") spng_hist hist) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_phys(spng_ctx * ctx, struct spng_phys * phys)} */
    public static native int nspng_get_phys(long ctx, long phys);

    /** {@code int spng_get_phys(spng_ctx * ctx, struct spng_phys * phys)} */
    public static int spng_get_phys(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_phys *") spng_phys phys) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_splt(spng_ctx * ctx, struct spng_splt * splt, uint32_t * n_splt)} */
    public static native int nspng_get_splt(long ctx, long splt, long n_splt);

    /** {@code int spng_get_splt(spng_ctx * ctx, struct spng_splt * splt, uint32_t * n_splt)} */
    public static int spng_get_splt(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_splt *") spng_splt splt, @NativeType("uint32_t *") IntBuffer n_splt) {
        if (CHECKS) {
            check(ctx);
            check(n_splt, 1);
        }
    ...
    /** {@code int spng_get_time(spng_ctx * ctx, struct spng_time * time)} */
    public static native int nspng_get_time(long ctx, long time);

    /** {@code int spng_get_time(spng_ctx * ctx, struct spng_time * time)} */
    public static int spng_get_time(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_time *") spng_time time) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_unknown_chunks(spng_ctx * ctx, struct spng_unknown_chunk * chunks, uint32_t * n_chunks)} */
    public static native int nspng_get_unknown_chunks(long ctx, long chunks, long n_chunks);

    /** {@code int spng_get_unknown_chunks(spng_ctx * ctx, struct spng_unknown_chunk * chunks, uint32_t * n_chunks)} */
    public static int spng_get_unknown_chunks(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_unknown_chunk *") spng_unknown_chunk chunks, @NativeType("uint32_t *") IntBuffer n_chunks) {
        if (CHECKS) {
            check(ctx);
            check(n_chunks, 1);
        }
    ...
    /** {@code int spng_get_offs(spng_ctx * ctx, struct spng_offs * offs)} */
    public static native int nspng_get_offs(long ctx, long offs);

    /** {@code int spng_get_offs(spng_ctx * ctx, struct spng_offs * offs)} */
    public static int spng_get_offs(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_offs *") spng_offs offs) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_get_exif(spng_ctx * ctx, struct spng_exif * exif)} */
    public static native int nspng_get_exif(long ctx, long exif);

    /** {@code int spng_get_exif(spng_ctx * ctx, struct spng_exif * exif)} */
    public static int spng_get_exif(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_exif *") spng_exif exif) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_ihdr(spng_ctx * ctx, struct spng_ihdr * ihdr)} */
    public static native int nspng_set_ihdr(long ctx, long ihdr);

    /** {@code int spng_set_ihdr(spng_ctx * ctx, struct spng_ihdr * ihdr)} */
    public static int spng_set_ihdr(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_ihdr *") spng_ihdr ihdr) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_plte(spng_ctx * ctx, struct spng_plte * plte)} */
    public static native int nspng_set_plte(long ctx, long plte);

    /** {@code int spng_set_plte(spng_ctx * ctx, struct spng_plte * plte)} */
    public static int spng_set_plte(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_plte *") spng_plte plte) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_trns(spng_ctx * ctx, struct spng_trns * trns)} */
    public static native int nspng_set_trns(long ctx, long trns);

    /** {@code int spng_set_trns(spng_ctx * ctx, struct spng_trns * trns)} */
    public static int spng_set_trns(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_trns *") spng_trns trns) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_chrm(spng_ctx * ctx, struct spng_chrm * chrm)} */
    public static native int nspng_set_chrm(long ctx, long chrm);

    /** {@code int spng_set_chrm(spng_ctx * ctx, struct spng_chrm * chrm)} */
    public static int spng_set_chrm(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_chrm *") spng_chrm chrm) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_chrm_int(spng_ctx * ctx, struct spng_chrm_int * chrm_int)} */
    public static native int nspng_set_chrm_int(long ctx, long chrm_int);

    /** {@code int spng_set_chrm_int(spng_ctx * ctx, struct spng_chrm_int * chrm_int)} */
    public static int spng_set_chrm_int(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_chrm_int *") spng_chrm_int chrm_int) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_iccp(spng_ctx * ctx, struct spng_iccp * iccp)} */
    public static native int nspng_set_iccp(long ctx, long iccp);

    /** {@code int spng_set_iccp(spng_ctx * ctx, struct spng_iccp * iccp)} */
    public static int spng_set_iccp(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_iccp *") spng_iccp iccp) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_sbit(spng_ctx * ctx, struct spng_sbit * sbit)} */
    public static native int nspng_set_sbit(long ctx, long sbit);

    /** {@code int spng_set_sbit(spng_ctx * ctx, struct spng_sbit * sbit)} */
    public static int spng_set_sbit(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_sbit *") spng_sbit sbit) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_text(spng_ctx * ctx, struct spng_text * text, uint32_t n_text)} */
    public static native int nspng_set_text(long ctx, long text, int n_text);

    /** {@code int spng_set_text(spng_ctx * ctx, struct spng_text * text, uint32_t n_text)} */
    public static int spng_set_text(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_text *") spng_text text, @NativeType("uint32_t") int n_text) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_bkgd(spng_ctx * ctx, struct spng_bkgd * bkgd)} */
    public static native int nspng_set_bkgd(long ctx, long bkgd);

    /** {@code int spng_set_bkgd(spng_ctx * ctx, struct spng_bkgd * bkgd)} */
    public static int spng_set_bkgd(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_bkgd *") spng_bkgd bkgd) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_hist(spng_ctx * ctx, struct spng_hist * hist)} */
    public static native int nspng_set_hist(long ctx, long hist);

    /** {@code int spng_set_hist(spng_ctx * ctx, struct spng_hist * hist)} */
    public static int spng_set_hist(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_hist *") spng_hist hist) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_phys(spng_ctx * ctx, struct spng_phys * phys)} */
    public static native int nspng_set_phys(long ctx, long phys);

    /** {@code int spng_set_phys(spng_ctx * ctx, struct spng_phys * phys)} */
    public static int spng_set_phys(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_phys *") spng_phys phys) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_splt(spng_ctx * ctx, struct spng_splt * splt, uint32_t n_splt)} */
    public static native int nspng_set_splt(long ctx, long splt, int n_splt);

    /** {@code int spng_set_splt(spng_ctx * ctx, struct spng_splt * splt, uint32_t n_splt)} */
    public static int spng_set_splt(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_splt *") spng_splt splt, @NativeType("uint32_t") int n_splt) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_time(spng_ctx * ctx, struct spng_time * time)} */
    public static native int nspng_set_time(long ctx, long time);

    /** {@code int spng_set_time(spng_ctx * ctx, struct spng_time * time)} */
    public static int spng_set_time(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_time *") spng_time time) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_unknown_chunks(spng_ctx * ctx, struct spng_unknown_chunk * chunks, uint32_t n_chunks)} */
    public static native int nspng_set_unknown_chunks(long ctx, long chunks, int n_chunks);

    /** {@code int spng_set_unknown_chunks(spng_ctx * ctx, struct spng_unknown_chunk * chunks, uint32_t n_chunks)} */
    public static int spng_set_unknown_chunks(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_unknown_chunk *") spng_unknown_chunk.Buffer chunks) {
        if (CHECKS) {
            check(ctx);
        }
        return nspng_set_unknown_chunks(ctx, chunks.address(), chunks.remaining());
    }

    // --- [ spng_set_offs ] ---

    /** {@code int spng_set_offs(spng_ctx * ctx, struct spng_offs * offs)} */
    public static native int nspng_set_offs(long ctx, long offs);

    /** {@code int spng_set_offs(spng_ctx * ctx, struct spng_offs * offs)} */
    public static int spng_set_offs(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_offs *") spng_offs offs) {
        if (CHECKS) {
            check(ctx);
        }
    ...
    /** {@code int spng_set_exif(spng_ctx * ctx, struct spng_exif * exif)} */
    public static native int nspng_set_exif(long ctx, long exif);

    /** {@code int spng_set_exif(spng_ctx * ctx, struct spng_exif * exif)} */
    public static int spng_set_exif(@NativeType("spng_ctx *") long ctx, @NativeType("struct spng_exif *") spng_exif exif) {
        if (CHECKS) {
            check(ctx);
        }
