...
public class NkStyleItem extends Struct<NkStyleItem> implements NativeResource {
    ...
    public static NkStyleItem malloc() {
        return new NkStyleItem(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static NkStyleItem malloc(MemoryStack stack) {
        return new NkStyleItem(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static NkStyleItem calloc(MemoryStack stack) {
        return new NkStyleItem(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<NkStyleItem, Buffer> implements NativeResource {
         ...
         * by {@link NkStyleItem#SIZEOF}, and its mark will be undefined.</p>
         *
