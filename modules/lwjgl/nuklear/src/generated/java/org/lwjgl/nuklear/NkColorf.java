...
public class NkColorf extends Struct<NkColorf> implements NativeResource {
    ...
    public NkColorf(long address, @Nullable ByteBuffer container) {
    ...
    public static NkColorf malloc() {
        return new NkColorf(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static @Nullable NkColorf createSafe(long address) {
        return address == NULL ? null : new NkColorf(address, null);
    }
    ...
    public static NkColorf.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends StructBuffer<NkColorf, Buffer> implements NativeResource {
         ...
         * by {@link NkColorf#SIZEOF}, and its mark will be undefined.</p>
         *
