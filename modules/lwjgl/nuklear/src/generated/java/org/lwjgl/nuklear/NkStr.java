...
public class NkStr extends Struct<NkStr> implements NativeResource {
    ...
    public static NkStr malloc() {
        return new NkStr(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<NkStr, Buffer> implements NativeResource {
         ...
         * by {@link NkStr#SIZEOF}, and its mark will be undefined.</p>
         *
