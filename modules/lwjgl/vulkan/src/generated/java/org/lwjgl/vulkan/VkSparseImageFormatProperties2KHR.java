...
public class VkSparseImageFormatProperties2KHR extends VkSparseImageFormatProperties2 {
    ...
    /** Sets the {@link VK11#VK_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2 STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2} value to the {@code sType} field. */
    @Override
    public VkSparseImageFormatProperties2KHR sType$Default() { return sType(VK11.VK_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2); }
    ...
    public static VkSparseImageFormatProperties2KHR malloc() {
        return new VkSparseImageFormatProperties2KHR(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkSparseImageFormatProperties2KHR calloc() {
        return new VkSparseImageFormatProperties2KHR(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkSparseImageFormatProperties2KHR create() {
        ...
        return new VkSparseImageFormatProperties2KHR(memAddress(container), container);
    }
    ...
    public static @Nullable VkSparseImageFormatProperties2KHR createSafe(long address) {
    ...
    public static VkSparseImageFormatProperties2KHR.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static VkSparseImageFormatProperties2KHR malloc(MemoryStack stack) {
        return new VkSparseImageFormatProperties2KHR(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkSparseImageFormatProperties2KHR calloc(MemoryStack stack) {
        return new VkSparseImageFormatProperties2KHR(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends VkSparseImageFormatProperties2.Buffer {
         ...
         * by {@link VkSparseImageFormatProperties2KHR#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        /** Sets the {@link VK11#VK_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2 STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2} value to the {@code sType} field. */
        @Override
        public VkSparseImageFormatProperties2KHR.Buffer sType$Default() { return sType(VK11.VK_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2); }
        /** Sets the specified value to the {@code pNext} field. */
        @Override
