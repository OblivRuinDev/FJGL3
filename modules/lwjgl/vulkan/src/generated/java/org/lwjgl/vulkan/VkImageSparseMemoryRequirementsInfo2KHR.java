...
public class VkImageSparseMemoryRequirementsInfo2KHR extends VkImageSparseMemoryRequirementsInfo2 {
    ...
    public static @Nullable VkImageSparseMemoryRequirementsInfo2KHR createSafe(long address) {
    ...
    public static VkImageSparseMemoryRequirementsInfo2KHR.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends VkImageSparseMemoryRequirementsInfo2.Buffer {
        ...
        public Class<?> getElementClass() {
            return VkImageSparseMemoryRequirementsInfo2KHR.class;
        }
