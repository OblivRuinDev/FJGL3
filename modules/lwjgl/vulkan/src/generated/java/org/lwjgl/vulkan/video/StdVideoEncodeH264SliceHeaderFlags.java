...
public class StdVideoEncodeH264SliceHeaderFlags extends Struct<StdVideoEncodeH264SliceHeaderFlags> implements NativeResource {
    ...
    public StdVideoEncodeH264SliceHeaderFlags(long address, @Nullable ByteBuffer container) {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoEncodeH264SliceHeaderFlags.BITFIELD0); }
    ...
    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoEncodeH264SliceHeaderFlags.BITFIELD0, value); }
    ...
    public static class Buffer extends StructBuffer<StdVideoEncodeH264SliceHeaderFlags, Buffer> implements NativeResource {
        ...
        public Class<?> getElementClass() {
            return StdVideoEncodeH264SliceHeaderFlags.class;
        }
