...
public class VkPhysicalDeviceVariablePointersFeaturesKHR extends VkPhysicalDeviceVariablePointersFeatures {
    ...
    public VkPhysicalDeviceVariablePointersFeaturesKHR(long address, @Nullable ByteBuffer container) {
    ...
    @Override
    public VkPhysicalDeviceVariablePointersFeaturesKHR sType$Default() { return sType(VK11.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES); }
    ...
    public static VkPhysicalDeviceVariablePointersFeaturesKHR malloc() {
        return new VkPhysicalDeviceVariablePointersFeaturesKHR(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceVariablePointersFeaturesKHR calloc() {
        return new VkPhysicalDeviceVariablePointersFeaturesKHR(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceVariablePointersFeaturesKHR create() {
        ...
        return new VkPhysicalDeviceVariablePointersFeaturesKHR(memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceVariablePointersFeaturesKHR create(long address) {
        return new VkPhysicalDeviceVariablePointersFeaturesKHR(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable VkPhysicalDeviceVariablePointersFeaturesKHR createSafe(long address) {
        return address == NULL ? null : new VkPhysicalDeviceVariablePointersFeaturesKHR(address, null);
    }
    ...
    public static VkPhysicalDeviceVariablePointersFeaturesKHR.@Nullable Buffer createSafe(long address, int capacity) {
     ...
     */
    public static VkPhysicalDeviceVariablePointersFeaturesKHR malloc(MemoryStack stack) {
        return new VkPhysicalDeviceVariablePointersFeaturesKHR(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceVariablePointersFeaturesKHR calloc(MemoryStack stack) {
        return new VkPhysicalDeviceVariablePointersFeaturesKHR(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVariablePointersFeaturesKHR.Buffer malloc(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceVariablePointersFeaturesKHR.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends VkPhysicalDeviceVariablePointersFeatures.Buffer {
         ...
         * by {@link VkPhysicalDeviceVariablePointersFeaturesKHR#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        /** Sets the {@link VK11#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES} value to the {@code sType} field. */
        @Override
        public VkPhysicalDeviceVariablePointersFeaturesKHR.Buffer sType$Default() { return sType(VK11.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES); }
        /** Sets the specified value to the {@code pNext} field. */
        @Override
