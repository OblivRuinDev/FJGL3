...
public class StdVideoDecodeH264ReferenceInfoFlags extends Struct<StdVideoDecodeH264ReferenceInfoFlags> implements NativeResource {
    ...
    public StdVideoDecodeH264ReferenceInfoFlags(long address, @Nullable ByteBuffer container) {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoDecodeH264ReferenceInfoFlags.BITFIELD0); }
    ...
    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoDecodeH264ReferenceInfoFlags.BITFIELD0, value); }
    ...
    public static class Buffer extends StructBuffer<StdVideoDecodeH264ReferenceInfoFlags, Buffer> implements NativeResource {
        ...
        public Class<?> getElementClass() {
            return StdVideoDecodeH264ReferenceInfoFlags.class;
        }
