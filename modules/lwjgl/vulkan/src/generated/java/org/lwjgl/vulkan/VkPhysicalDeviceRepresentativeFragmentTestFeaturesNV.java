...
public class VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV extends Struct<VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV> implements NativeResource {
    ...
    public static VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV malloc() {
        return new VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV calloc() {
        return new VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV create() {
        ...
        return new VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV(memAddress(container), container);
    }
    ...
    public static VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV malloc(MemoryStack stack) {
        return new VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV calloc(MemoryStack stack) {
        return new VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV#SIZEOF}, and its mark will be undefined.</p>
         *
