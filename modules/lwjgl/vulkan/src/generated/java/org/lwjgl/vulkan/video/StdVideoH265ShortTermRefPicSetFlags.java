...
public class StdVideoH265ShortTermRefPicSetFlags extends Struct<StdVideoH265ShortTermRefPicSetFlags> implements NativeResource {
    ...
    public static @Nullable StdVideoH265ShortTermRefPicSetFlags createSafe(long address) {
    ...
    public static StdVideoH265ShortTermRefPicSetFlags.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoH265ShortTermRefPicSetFlags.BITFIELD0); }
    ...
    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoH265ShortTermRefPicSetFlags.BITFIELD0, value); }
