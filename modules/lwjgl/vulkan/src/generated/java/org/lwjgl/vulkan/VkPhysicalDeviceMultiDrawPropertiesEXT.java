...
public class VkPhysicalDeviceMultiDrawPropertiesEXT extends Struct<VkPhysicalDeviceMultiDrawPropertiesEXT> implements NativeResource {
    ...
    /**
     * Creates a {@code VkPhysicalDeviceMultiDrawPropertiesEXT} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
     * visible to the struct instance and vice versa.
     *
     * <p>The created instance holds a strong reference to the container object.</p>
     */
    public VkPhysicalDeviceMultiDrawPropertiesEXT(ByteBuffer container) {
    ...
    public VkPhysicalDeviceMultiDrawPropertiesEXT sType(@NativeType("VkStructureType") int value) { nsType(address(), value); return this; }
    /** Sets the {@link EXTMultiDraw#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_PROPERTIES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_PROPERTIES_EXT} value to the {@code sType} field. */
    public VkPhysicalDeviceMultiDrawPropertiesEXT sType$Default() { return sType(EXTMultiDraw.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_PROPERTIES_EXT); }
    /** Sets the specified value to the {@code pNext} field. */
    public VkPhysicalDeviceMultiDrawPropertiesEXT pNext(@NativeType("void *") long value) { npNext(address(), value); return this; }

    /** Initializes this struct with the specified values. */
    public VkPhysicalDeviceMultiDrawPropertiesEXT set(
        int sType,
        long pNext
    ) {
        sType(sType);
     ...
     * @return this struct
     */
    public VkPhysicalDeviceMultiDrawPropertiesEXT set(VkPhysicalDeviceMultiDrawPropertiesEXT src) {
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceMultiDrawPropertiesEXT.Buffer} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed.
     *
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceMultiDrawPropertiesEXT.Buffer} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceMultiDrawPropertiesEXT.Buffer} instance allocated with {@link BufferUtils}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Create a {@link VkPhysicalDeviceMultiDrawPropertiesEXT.Buffer} instance at the specified memory.
     *
    ...
    /**
     * Returns a new {@code VkPhysicalDeviceMultiDrawPropertiesEXT} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceMultiDrawPropertiesEXT.Buffer} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkPhysicalDeviceMultiDrawPropertiesEXT.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    ...
    /** An array of {@link VkPhysicalDeviceMultiDrawPropertiesEXT} structs. */
    public static class Buffer extends StructBuffer<VkPhysicalDeviceMultiDrawPropertiesEXT, Buffer> implements NativeResource {

        private static final VkPhysicalDeviceMultiDrawPropertiesEXT ELEMENT_FACTORY = VkPhysicalDeviceMultiDrawPropertiesEXT.create(-1L);
        ...
        /** @return the value of the {@code sType} field. */
        @NativeType("VkStructureType")
        public int sType() { return VkPhysicalDeviceMultiDrawPropertiesEXT.nsType(address()); }
        /** @return the value of the {@code pNext} field. */
        @NativeType("void *")
        ...
        /** Sets the specified value to the {@code sType} field. */
        public VkPhysicalDeviceMultiDrawPropertiesEXT.Buffer sType(@NativeType("VkStructureType") int value) { VkPhysicalDeviceMultiDrawPropertiesEXT.nsType(address(), value); return this; }
        /** Sets the {@link EXTMultiDraw#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_PROPERTIES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_PROPERTIES_EXT} value to the {@code sType} field. */
        public VkPhysicalDeviceMultiDrawPropertiesEXT.Buffer sType$Default() { return sType(EXTMultiDraw.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_PROPERTIES_EXT); }
        /** Sets the specified value to the {@code pNext} field. */
        public VkPhysicalDeviceMultiDrawPropertiesEXT.Buffer pNext(@NativeType("void *") long value) { VkPhysicalDeviceMultiDrawPropertiesEXT.npNext(address(), value); return this; }
