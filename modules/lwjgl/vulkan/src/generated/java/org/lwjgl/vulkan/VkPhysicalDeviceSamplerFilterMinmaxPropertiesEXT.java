...
public class VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT extends VkPhysicalDeviceSamplerFilterMinmaxProperties {
    ...
    public static VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT malloc() {
        return new VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT calloc() {
        return new VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT create() {
        ...
        return new VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT(memAddress(container), container);
    }
    ...
    public static @Nullable VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT createSafe(long address) {
    ...
    public static VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT.@Nullable Buffer createSafe(long address, int capacity) {
     ...
     */
    public static VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT malloc(MemoryStack stack) {
        return new VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT calloc(MemoryStack stack) {
        return new VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT.Buffer malloc(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends VkPhysicalDeviceSamplerFilterMinmaxProperties.Buffer {
         ...
         * by {@link VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        public Class<?> getElementClass() {
            return VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT.class;
        }
