...
public class VkDebugMarkerMarkerInfoEXT extends Struct<VkDebugMarkerMarkerInfoEXT> implements NativeResource {
    ...
    /** @return a {@link ByteBuffer} view of the null-terminated string pointed to by the {@code pMarkerName} field. */
    @NativeType("char const *")
    public ByteBuffer pMarkerName() { return npMarkerName(address()); }
    /** @return the null-terminated string pointed to by the {@code pMarkerName} field. */
    @NativeType("char const *")
    ...
    /** Sets the {@link EXTDebugMarker#VK_STRUCTURE_TYPE_DEBUG_MARKER_MARKER_INFO_EXT STRUCTURE_TYPE_DEBUG_MARKER_MARKER_INFO_EXT} value to the {@code sType} field. */
    ...
    public static VkDebugMarkerMarkerInfoEXT malloc() {
        return new VkDebugMarkerMarkerInfoEXT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkDebugMarkerMarkerInfoEXT calloc() {
        return new VkDebugMarkerMarkerInfoEXT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkDebugMarkerMarkerInfoEXT create() {
        ...
        return new VkDebugMarkerMarkerInfoEXT(memAddress(container), container);
    }
    ...
    public static VkDebugMarkerMarkerInfoEXT malloc(MemoryStack stack) {
        return new VkDebugMarkerMarkerInfoEXT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkDebugMarkerMarkerInfoEXT calloc(MemoryStack stack) {
        return new VkDebugMarkerMarkerInfoEXT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkDebugMarkerMarkerInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkDebugMarkerMarkerInfoEXT#SIZEOF}, and its mark will be undefined.</p>
         *
