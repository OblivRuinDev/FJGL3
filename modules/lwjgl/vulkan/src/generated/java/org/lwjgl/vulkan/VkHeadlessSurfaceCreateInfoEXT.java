 ...
 * }}</pre>
 */
public class VkHeadlessSurfaceCreateInfoEXT extends Struct<VkHeadlessSurfaceCreateInfoEXT> implements NativeResource {
    ...
    /** Sets the {@link EXTHeadlessSurface#VK_STRUCTURE_TYPE_HEADLESS_SURFACE_CREATE_INFO_EXT STRUCTURE_TYPE_HEADLESS_SURFACE_CREATE_INFO_EXT} value to the {@code sType} field. */
    ...
    public static VkHeadlessSurfaceCreateInfoEXT malloc() {
        return new VkHeadlessSurfaceCreateInfoEXT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkHeadlessSurfaceCreateInfoEXT calloc() {
        return new VkHeadlessSurfaceCreateInfoEXT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkHeadlessSurfaceCreateInfoEXT create() {
        ...
        return new VkHeadlessSurfaceCreateInfoEXT(memAddress(container), container);
    }
    ...
    public static VkHeadlessSurfaceCreateInfoEXT create(long address) {
        return new VkHeadlessSurfaceCreateInfoEXT(address, null);
    }
    ...
    public static VkHeadlessSurfaceCreateInfoEXT malloc(MemoryStack stack) {
        return new VkHeadlessSurfaceCreateInfoEXT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkHeadlessSurfaceCreateInfoEXT calloc(MemoryStack stack) {
        return new VkHeadlessSurfaceCreateInfoEXT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkHeadlessSurfaceCreateInfoEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkHeadlessSurfaceCreateInfoEXT#SIZEOF}, and its mark will be undefined.</p>
         *
