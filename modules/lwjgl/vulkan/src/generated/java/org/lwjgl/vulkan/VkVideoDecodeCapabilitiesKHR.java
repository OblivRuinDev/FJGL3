...
public class VkVideoDecodeCapabilitiesKHR extends Struct<VkVideoDecodeCapabilitiesKHR> implements NativeResource {
    ...
    public static VkVideoDecodeCapabilitiesKHR malloc() {
        return new VkVideoDecodeCapabilitiesKHR(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkVideoDecodeCapabilitiesKHR calloc() {
        return new VkVideoDecodeCapabilitiesKHR(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkVideoDecodeCapabilitiesKHR create() {
        ...
        return new VkVideoDecodeCapabilitiesKHR(memAddress(container), container);
    }
    ...
    public static VkVideoDecodeCapabilitiesKHR create(long address) {
        return new VkVideoDecodeCapabilitiesKHR(address, null);
    }
    ...
    public static VkVideoDecodeCapabilitiesKHR malloc(MemoryStack stack) {
        return new VkVideoDecodeCapabilitiesKHR(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkVideoDecodeCapabilitiesKHR calloc(MemoryStack stack) {
        return new VkVideoDecodeCapabilitiesKHR(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkVideoDecodeCapabilitiesKHR, Buffer> implements NativeResource {
         ...
         * by {@link VkVideoDecodeCapabilitiesKHR#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        public Class<?> getElementClass() {
            return VkVideoDecodeCapabilitiesKHR.class;
        }
