 ...
 * }</code></pre>
 */
public class VkQueueFamilyProperties2 extends Struct<VkQueueFamilyProperties2> implements NativeResource {
    ...
    /** @return a {@link VkQueueFamilyProperties} view of the {@code queueFamilyProperties} field. */
    ...
    public static VkQueueFamilyProperties2 malloc() {
        return new VkQueueFamilyProperties2(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkQueueFamilyProperties2 calloc() {
        return new VkQueueFamilyProperties2(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkQueueFamilyProperties2 create() {
        ...
        return new VkQueueFamilyProperties2(memAddress(container), container);
    }
    ...
    public static VkQueueFamilyProperties2 create(long address) {
        return new VkQueueFamilyProperties2(address, null);
    }
    ...
    public static VkQueueFamilyProperties2 malloc(MemoryStack stack) {
        return new VkQueueFamilyProperties2(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkQueueFamilyProperties2 calloc(MemoryStack stack) {
        return new VkQueueFamilyProperties2(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<VkQueueFamilyProperties2, Buffer> implements NativeResource {
         ...
         * by {@link VkQueueFamilyProperties2#SIZEOF}, and its mark will be undefined.</p>
         *
