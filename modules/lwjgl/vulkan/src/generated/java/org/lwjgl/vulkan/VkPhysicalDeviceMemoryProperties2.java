 ...
 * }</code></pre>
 */
public class VkPhysicalDeviceMemoryProperties2 extends Struct<VkPhysicalDeviceMemoryProperties2> implements NativeResource {
    ...
    public VkPhysicalDeviceMemoryProperties2(long address, @Nullable ByteBuffer container) {
    ...
    /** @return a {@link VkPhysicalDeviceMemoryProperties} view of the {@code memoryProperties} field. */
    ...
    public static VkPhysicalDeviceMemoryProperties2 malloc() {
        return new VkPhysicalDeviceMemoryProperties2(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceMemoryProperties2 calloc() {
        return new VkPhysicalDeviceMemoryProperties2(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceMemoryProperties2 create() {
        ...
        return new VkPhysicalDeviceMemoryProperties2(memAddress(container), container);
    }
    ...
    public static @Nullable VkPhysicalDeviceMemoryProperties2 createSafe(long address) {
        return address == NULL ? null : new VkPhysicalDeviceMemoryProperties2(address, null);
    }
    ...
    public static VkPhysicalDeviceMemoryProperties2.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceMemoryProperties2, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceMemoryProperties2#SIZEOF}, and its mark will be undefined.</p>
         *
