...
public class VkPipelineTessellationDomainOriginStateCreateInfoKHR extends VkPipelineTessellationDomainOriginStateCreateInfo {
    ...
    public static @Nullable VkPipelineTessellationDomainOriginStateCreateInfoKHR createSafe(long address) {
    ...
    public static VkPipelineTessellationDomainOriginStateCreateInfoKHR.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends VkPipelineTessellationDomainOriginStateCreateInfo.Buffer {
        ...
        public Class<?> getElementClass() {
            return VkPipelineTessellationDomainOriginStateCreateInfoKHR.class;
        }
