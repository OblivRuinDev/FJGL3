...
public class StdVideoEncodeH264ReferenceListsInfoFlags extends Struct<StdVideoEncodeH264ReferenceListsInfoFlags> implements NativeResource {
    ...
    public StdVideoEncodeH264ReferenceListsInfoFlags(long address, @Nullable ByteBuffer container) {
    ...
    public static @Nullable StdVideoEncodeH264ReferenceListsInfoFlags createSafe(long address) {
    ...
    public static StdVideoEncodeH264ReferenceListsInfoFlags.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends StructBuffer<StdVideoEncodeH264ReferenceListsInfoFlags, Buffer> implements NativeResource {
        ...
        public Class<?> getElementClass() {
            return StdVideoEncodeH264ReferenceListsInfoFlags.class;
        }
