...
public class VkQueueFamilyProperties2KHR extends VkQueueFamilyProperties2 {
    ...
    public static VkQueueFamilyProperties2KHR malloc() {
        return new VkQueueFamilyProperties2KHR(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkQueueFamilyProperties2KHR calloc() {
        return new VkQueueFamilyProperties2KHR(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkQueueFamilyProperties2KHR create() {
        ...
        return new VkQueueFamilyProperties2KHR(memAddress(container), container);
    }
    ...
    public static @Nullable VkQueueFamilyProperties2KHR createSafe(long address) {
        return address == NULL ? null : new VkQueueFamilyProperties2KHR(address, null);
    }
    ...
    public static VkQueueFamilyProperties2KHR.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static VkQueueFamilyProperties2KHR malloc(MemoryStack stack) {
        return new VkQueueFamilyProperties2KHR(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkQueueFamilyProperties2KHR calloc(MemoryStack stack) {
        return new VkQueueFamilyProperties2KHR(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends VkQueueFamilyProperties2.Buffer {
         ...
         * by {@link VkQueueFamilyProperties2KHR#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        public Class<?> getElementClass() {
            return VkQueueFamilyProperties2KHR.class;
        }
