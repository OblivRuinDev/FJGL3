...
public final class VALVEFragmentDensityMapLayered {

    public static final int VK_VALVE_FRAGMENT_DENSITY_MAP_LAYERED_SPEC_VERSION = 1;

    public static final String VK_VALVE_FRAGMENT_DENSITY_MAP_LAYERED_EXTENSION_NAME = "VK_VALVE_fragment_density_map_layered";
    ...
    public static final int VK_RENDER_PASS_CREATE_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE = 0x4;

    public static final int VK_RENDERING_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE = 0x20;

    public static final long VK_PIPELINE_CREATE_2_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE = 0x10000000000L;

    private VALVEFragmentDensityMapLayered() {}
