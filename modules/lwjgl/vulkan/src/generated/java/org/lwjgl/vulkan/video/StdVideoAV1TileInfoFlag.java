...
public class StdVideoAV1TileInfoFlag extends Struct<StdVideoAV1TileInfoFlag> implements NativeResource {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoAV1TileInfoFlag.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoAV1TileInfoFlag.BITFIELD1); }
    static int nreserved(long struct) { return nbitfield1(struct) & 0x7F_FF_FF_FF; }

    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoAV1TileInfoFlag.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoAV1TileInfoFlag.BITFIELD1, value); }
    static void nreserved(long struct, int value) { nbitfield1(struct, (nbitfield1(struct) & 0x80_00_00_00) | (value & 0x7F_FF_FF_FF)); }
    ...
    public static class Buffer extends StructBuffer<StdVideoAV1TileInfoFlag, Buffer> implements NativeResource {
        ...
        public Class<?> getElementClass() {
            return StdVideoAV1TileInfoFlag.class;
        }
