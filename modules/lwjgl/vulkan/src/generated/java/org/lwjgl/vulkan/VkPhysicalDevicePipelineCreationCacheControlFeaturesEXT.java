...
public class VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT extends VkPhysicalDevicePipelineCreationCacheControlFeatures {
    ...
    public static @Nullable VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT createSafe(long address) {
    ...
    public static VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends VkPhysicalDevicePipelineCreationCacheControlFeatures.Buffer {
        ...
        public Class<?> getElementClass() {
            return VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT.class;
        }
