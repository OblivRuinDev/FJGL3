...
public class StdVideoDecodeH264PictureInfoFlags extends Struct<StdVideoDecodeH264PictureInfoFlags> implements NativeResource {
    ...
    public StdVideoDecodeH264PictureInfoFlags(long address, @Nullable ByteBuffer container) {
    ...
    public static StdVideoDecodeH264PictureInfoFlags malloc() {
        return new StdVideoDecodeH264PictureInfoFlags(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static StdVideoDecodeH264PictureInfoFlags calloc() {
        return new StdVideoDecodeH264PictureInfoFlags(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static StdVideoDecodeH264PictureInfoFlags create() {
        ...
        return new StdVideoDecodeH264PictureInfoFlags(memAddress(container), container);
    }
    ...
    public static StdVideoDecodeH264PictureInfoFlags create(long address) {
        return new StdVideoDecodeH264PictureInfoFlags(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable StdVideoDecodeH264PictureInfoFlags createSafe(long address) {
        return address == NULL ? null : new StdVideoDecodeH264PictureInfoFlags(address, null);
    }
    ...
    public static StdVideoDecodeH264PictureInfoFlags.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static StdVideoDecodeH264PictureInfoFlags malloc(MemoryStack stack) {
        return new StdVideoDecodeH264PictureInfoFlags(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static StdVideoDecodeH264PictureInfoFlags calloc(MemoryStack stack) {
        return new StdVideoDecodeH264PictureInfoFlags(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoDecodeH264PictureInfoFlags.BITFIELD0); }
    ...
    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoDecodeH264PictureInfoFlags.BITFIELD0, value); }
    ...
    public static class Buffer extends StructBuffer<StdVideoDecodeH264PictureInfoFlags, Buffer> implements NativeResource {
         ...
         * by {@link StdVideoDecodeH264PictureInfoFlags#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        public Class<?> getElementClass() {
            return StdVideoDecodeH264PictureInfoFlags.class;
        }
