...
public class StdVideoDecodeAV1ReferenceInfoFlags extends Struct<StdVideoDecodeAV1ReferenceInfoFlags> implements NativeResource {
    ...
    public StdVideoDecodeAV1ReferenceInfoFlags(long address, @Nullable ByteBuffer container) {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoDecodeAV1ReferenceInfoFlags.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoDecodeAV1ReferenceInfoFlags.BITFIELD1); }
    static int nreserved(long struct) { return nbitfield1(struct) & 0x3F_FF_FF_FF; }

    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoDecodeAV1ReferenceInfoFlags.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoDecodeAV1ReferenceInfoFlags.BITFIELD1, value); }
    ...
    public static class Buffer extends StructBuffer<StdVideoDecodeAV1ReferenceInfoFlags, Buffer> implements NativeResource {
        ...
        public Class<?> getElementClass() {
            return StdVideoDecodeAV1ReferenceInfoFlags.class;
        }
