...
public class StdVideoH264PpsFlags extends Struct<StdVideoH264PpsFlags> implements NativeResource {
    ...
    public StdVideoH264PpsFlags(long address, @Nullable ByteBuffer container) {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoH264PpsFlags.BITFIELD0); }
    ...
    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoH264PpsFlags.BITFIELD0, value); }
