...
public class StdVideoAV1LoopFilterFlags extends Struct<StdVideoAV1LoopFilterFlags> implements NativeResource {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoAV1LoopFilterFlags.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoAV1LoopFilterFlags.BITFIELD1); }
    static int nreserved(long struct) { return nbitfield1(struct) & 0x3F_FF_FF_FF; }

    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoAV1LoopFilterFlags.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoAV1LoopFilterFlags.BITFIELD1, value); }
    ...
    public static class Buffer extends StructBuffer<StdVideoAV1LoopFilterFlags, Buffer> implements NativeResource {
        ...
        public Class<?> getElementClass() {
            return StdVideoAV1LoopFilterFlags.class;
        }
