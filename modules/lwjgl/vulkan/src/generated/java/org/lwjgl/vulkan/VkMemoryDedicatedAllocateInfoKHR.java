...
public class VkMemoryDedicatedAllocateInfoKHR extends VkMemoryDedicatedAllocateInfo {
    ...
    public static VkMemoryDedicatedAllocateInfoKHR malloc() {
        return new VkMemoryDedicatedAllocateInfoKHR(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkMemoryDedicatedAllocateInfoKHR calloc() {
        return new VkMemoryDedicatedAllocateInfoKHR(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkMemoryDedicatedAllocateInfoKHR create() {
        ...
        return new VkMemoryDedicatedAllocateInfoKHR(memAddress(container), container);
    }
    ...
    public static class Buffer extends VkMemoryDedicatedAllocateInfo.Buffer {
         ...
         * by {@link VkMemoryDedicatedAllocateInfoKHR#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        public Class<?> getElementClass() {
            return VkMemoryDedicatedAllocateInfoKHR.class;
        }
