...
public class StdVideoH264SpsVuiFlags extends Struct<StdVideoH264SpsVuiFlags> implements NativeResource {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoH264SpsVuiFlags.BITFIELD0); }
    ...
    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoH264SpsVuiFlags.BITFIELD0, value); }
    ...
    public static class Buffer extends StructBuffer<StdVideoH264SpsVuiFlags, Buffer> implements NativeResource {
        ...
        public Class<?> getElementClass() {
            return StdVideoH264SpsVuiFlags.class;
        }
