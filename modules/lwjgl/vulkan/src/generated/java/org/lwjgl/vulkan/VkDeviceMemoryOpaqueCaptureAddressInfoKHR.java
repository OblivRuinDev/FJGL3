...
public class VkDeviceMemoryOpaqueCaptureAddressInfoKHR extends VkDeviceMemoryOpaqueCaptureAddressInfo {
    ...
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR(long address, @Nullable ByteBuffer container) {
    ...
    public static @Nullable VkDeviceMemoryOpaqueCaptureAddressInfoKHR createSafe(long address) {
    ...
    public static VkDeviceMemoryOpaqueCaptureAddressInfoKHR.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends VkDeviceMemoryOpaqueCaptureAddressInfo.Buffer {
        ...
        public Class<?> getElementClass() {
            return VkDeviceMemoryOpaqueCaptureAddressInfoKHR.class;
        }
