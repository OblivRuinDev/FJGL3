...
public class VkPhysicalDeviceOpticalFlowFeaturesNV extends Struct<VkPhysicalDeviceOpticalFlowFeaturesNV> implements NativeResource {
    ...
    public VkPhysicalDeviceOpticalFlowFeaturesNV(long address, @Nullable ByteBuffer container) {
    ...
    /** @return the value of the {@code opticalFlow} field. */
    @NativeType("VkBool32")
    ...
    /** Sets the {@link NVOpticalFlow#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPTICAL_FLOW_FEATURES_NV STRUCTURE_TYPE_PHYSICAL_DEVICE_OPTICAL_FLOW_FEATURES_NV} value to the {@code sType} field. */
    ...
    /** Sets the specified value to the {@code opticalFlow} field. */
