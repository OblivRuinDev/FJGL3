...
public class VkFormatProperties2KHR extends VkFormatProperties2 {
    ...
    public VkFormatProperties2KHR(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    /**
     * Creates a {@code VkFormatProperties2KHR} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** Returns a new {@code VkFormatProperties2KHR} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static VkFormatProperties2KHR malloc() {
        return new VkFormatProperties2KHR(nmemAllocChecked(SIZEOF), null);
    }

    /** Returns a new {@code VkFormatProperties2KHR} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static VkFormatProperties2KHR calloc() {
        return new VkFormatProperties2KHR(nmemCallocChecked(1, SIZEOF), null);
    }

    /** Returns a new {@code VkFormatProperties2KHR} instance allocated with {@link BufferUtils}. */
    public static VkFormatProperties2KHR create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return new VkFormatProperties2KHR(memAddress(container), container);
    }

    /** Returns a new {@code VkFormatProperties2KHR} instance for the specified memory address. */
    public static VkFormatProperties2KHR create(long address) {
        return new VkFormatProperties2KHR(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    public static @Nullable VkFormatProperties2KHR createSafe(long address) {
    ...
    public static VkFormatProperties2KHR.@Nullable Buffer createSafe(long address, int capacity) {
        return address == NULL ? null : new Buffer(address, capacity);
    }

    /**
     * Returns a new {@code VkFormatProperties2KHR} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack the stack from which to allocate
     */
    public static VkFormatProperties2KHR malloc(MemoryStack stack) {
        return new VkFormatProperties2KHR(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }

    /**
     * Returns a new {@code VkFormatProperties2KHR} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    public static VkFormatProperties2KHR calloc(MemoryStack stack) {
        return new VkFormatProperties2KHR(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
     ...
     * @param capacity the buffer capacity
     */
    public static VkFormatProperties2KHR.Buffer malloc(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkFormatProperties2KHR.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends VkFormatProperties2.Buffer {
        ...
        private static final VkFormatProperties2KHR ELEMENT_FACTORY = VkFormatProperties2KHR.create(-1L);

        /**
         * Creates a new {@code VkFormatProperties2KHR.Buffer} instance backed by the specified container.
         *
         * <p>Changes to the container's content will be visible to the struct buffer instance and vice versa. The two buffers' position, limit, and mark values
         * will be independent. The new buffer's position will be zero, its capacity and its limit will be the number of bytes remaining in this buffer divided
         * by {@link VkFormatProperties2KHR#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        @Override
        protected VkFormatProperties2KHR getElementFactory() {
