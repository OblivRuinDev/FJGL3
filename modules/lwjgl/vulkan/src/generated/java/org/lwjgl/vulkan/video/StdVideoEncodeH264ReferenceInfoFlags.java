...
public class StdVideoEncodeH264ReferenceInfoFlags extends Struct<StdVideoEncodeH264ReferenceInfoFlags> implements NativeResource {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoEncodeH264ReferenceInfoFlags.BITFIELD0); }
    ...
    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoEncodeH264ReferenceInfoFlags.BITFIELD0, value); }
    ...
    public static class Buffer extends StructBuffer<StdVideoEncodeH264ReferenceInfoFlags, Buffer> implements NativeResource {
        ...
        public Class<?> getElementClass() {
            return StdVideoEncodeH264ReferenceInfoFlags.class;
        }
