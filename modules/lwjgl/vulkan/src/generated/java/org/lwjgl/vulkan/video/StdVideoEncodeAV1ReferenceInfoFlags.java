...
public class StdVideoEncodeAV1ReferenceInfoFlags extends Struct<StdVideoEncodeAV1ReferenceInfoFlags> implements NativeResource {
    ...
    public StdVideoEncodeAV1ReferenceInfoFlags(long address, @Nullable ByteBuffer container) {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoEncodeAV1ReferenceInfoFlags.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoEncodeAV1ReferenceInfoFlags.BITFIELD1); }
    static int nreserved(long struct) { return nbitfield1(struct) & 0x3F_FF_FF_FF; }

    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoEncodeAV1ReferenceInfoFlags.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoEncodeAV1ReferenceInfoFlags.BITFIELD1, value); }
