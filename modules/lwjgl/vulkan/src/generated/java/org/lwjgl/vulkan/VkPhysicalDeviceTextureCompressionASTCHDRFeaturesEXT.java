...
public class VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT extends VkPhysicalDeviceTextureCompressionASTCHDRFeatures {
    ...
    public static @Nullable VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT createSafe(long address) {
    ...
    public static VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends VkPhysicalDeviceTextureCompressionASTCHDRFeatures.Buffer {
        ...
        public Class<?> getElementClass() {
            return VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT.class;
        }
