 ...
 * }}</pre>
 */
public class VkAccelerationStructureDeviceAddressInfoKHR extends Struct<VkAccelerationStructureDeviceAddressInfoKHR> implements NativeResource {
    ...
    /** Sets the {@link KHRAccelerationStructure#VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DEVICE_ADDRESS_INFO_KHR STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DEVICE_ADDRESS_INFO_KHR} value to the {@code sType} field. */
    ...
    public static VkAccelerationStructureDeviceAddressInfoKHR malloc() {
        return new VkAccelerationStructureDeviceAddressInfoKHR(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkAccelerationStructureDeviceAddressInfoKHR calloc() {
        return new VkAccelerationStructureDeviceAddressInfoKHR(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkAccelerationStructureDeviceAddressInfoKHR create() {
        ...
        return new VkAccelerationStructureDeviceAddressInfoKHR(memAddress(container), container);
    }
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureDeviceAddressInfoKHR.Buffer malloc(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkAccelerationStructureDeviceAddressInfoKHR.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkAccelerationStructureDeviceAddressInfoKHR, Buffer> implements NativeResource {
         ...
         * by {@link VkAccelerationStructureDeviceAddressInfoKHR#SIZEOF}, and its mark will be undefined.</p>
         *
