...
public class VkPhysicalDeviceFeatures2KHR extends VkPhysicalDeviceFeatures2 {
    ...
    public VkPhysicalDeviceFeatures2KHR(long address, @Nullable ByteBuffer container) {
    ...
    public static VkPhysicalDeviceFeatures2KHR malloc() {
        return new VkPhysicalDeviceFeatures2KHR(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceFeatures2KHR calloc() {
        return new VkPhysicalDeviceFeatures2KHR(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceFeatures2KHR create() {
        ...
        return new VkPhysicalDeviceFeatures2KHR(memAddress(container), container);
    }
    ...
    public static class Buffer extends VkPhysicalDeviceFeatures2.Buffer {
         ...
         * by {@link VkPhysicalDeviceFeatures2KHR#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        public Class<?> getElementClass() {
            return VkPhysicalDeviceFeatures2KHR.class;
        }
