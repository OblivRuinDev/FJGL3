...
public class VkPhysicalDevicePointClippingProperties extends Struct<VkPhysicalDevicePointClippingProperties> implements NativeResource {
    ...
    /**
     * Creates a {@code VkPhysicalDevicePointClippingProperties} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /**
     * Returns a new {@link VkPhysicalDevicePointClippingProperties.Buffer} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed.
     *
    ...
    /**
     * Returns a new {@link VkPhysicalDevicePointClippingProperties.Buffer} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkPhysicalDevicePointClippingProperties.Buffer} instance allocated with {@link BufferUtils}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@code VkPhysicalDevicePointClippingProperties} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@code VkPhysicalDevicePointClippingProperties} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    /**
     * Returns a new {@link VkPhysicalDevicePointClippingProperties.Buffer} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link VkPhysicalDevicePointClippingProperties.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack    the stack from which to allocate
     * @param capacity the buffer capacity
     */
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDevicePointClippingProperties, Buffer> implements NativeResource {

        private static final VkPhysicalDevicePointClippingProperties ELEMENT_FACTORY = VkPhysicalDevicePointClippingProperties.create(-1L);
