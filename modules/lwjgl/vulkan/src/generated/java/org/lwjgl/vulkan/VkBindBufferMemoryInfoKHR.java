...
public class VkBindBufferMemoryInfoKHR extends VkBindBufferMemoryInfo {
    ...
    public VkBindBufferMemoryInfoKHR(long address, @Nullable ByteBuffer container) {
    ...
    public static VkBindBufferMemoryInfoKHR malloc() {
        return new VkBindBufferMemoryInfoKHR(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkBindBufferMemoryInfoKHR calloc() {
        return new VkBindBufferMemoryInfoKHR(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkBindBufferMemoryInfoKHR create() {
        ...
        return new VkBindBufferMemoryInfoKHR(memAddress(container), container);
    }
    ...
    public static VkBindBufferMemoryInfoKHR.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static class Buffer extends VkBindBufferMemoryInfo.Buffer {
         ...
         * by {@link VkBindBufferMemoryInfoKHR#SIZEOF}, and its mark will be undefined.</p>
         *
