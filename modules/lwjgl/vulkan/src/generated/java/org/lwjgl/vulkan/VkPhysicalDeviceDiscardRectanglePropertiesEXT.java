 ...
 * }}</pre>
 */
public class VkPhysicalDeviceDiscardRectanglePropertiesEXT extends Struct<VkPhysicalDeviceDiscardRectanglePropertiesEXT> implements NativeResource {
    ...
    /** @return the value of the {@code maxDiscardRectangles} field. */
    @NativeType("uint32_t")
    ...
    /** Sets the {@link EXTDiscardRectangles#VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DISCARD_RECTANGLE_PROPERTIES_EXT STRUCTURE_TYPE_PHYSICAL_DEVICE_DISCARD_RECTANGLE_PROPERTIES_EXT} value to the {@code sType} field. */
    ...
    public static VkPhysicalDeviceDiscardRectanglePropertiesEXT malloc() {
        return new VkPhysicalDeviceDiscardRectanglePropertiesEXT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceDiscardRectanglePropertiesEXT calloc() {
        return new VkPhysicalDeviceDiscardRectanglePropertiesEXT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkPhysicalDeviceDiscardRectanglePropertiesEXT create() {
        ...
        return new VkPhysicalDeviceDiscardRectanglePropertiesEXT(memAddress(container), container);
    }
    ...
    public static @Nullable VkPhysicalDeviceDiscardRectanglePropertiesEXT createSafe(long address) {
        return address == NULL ? null : new VkPhysicalDeviceDiscardRectanglePropertiesEXT(address, null);
    }
    ...
    public static VkPhysicalDeviceDiscardRectanglePropertiesEXT.@Nullable Buffer createSafe(long address, int capacity) {
     ...
     */
    public static VkPhysicalDeviceDiscardRectanglePropertiesEXT malloc(MemoryStack stack) {
        return new VkPhysicalDeviceDiscardRectanglePropertiesEXT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
     ...
     * @param stack the stack from which to allocate
     */
    public static VkPhysicalDeviceDiscardRectanglePropertiesEXT calloc(MemoryStack stack) {
        return new VkPhysicalDeviceDiscardRectanglePropertiesEXT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceDiscardRectanglePropertiesEXT.Buffer malloc(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkPhysicalDeviceDiscardRectanglePropertiesEXT.Buffer calloc(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkPhysicalDeviceDiscardRectanglePropertiesEXT, Buffer> implements NativeResource {
         ...
         * by {@link VkPhysicalDeviceDiscardRectanglePropertiesEXT#SIZEOF}, and its mark will be undefined.</p>
         *
