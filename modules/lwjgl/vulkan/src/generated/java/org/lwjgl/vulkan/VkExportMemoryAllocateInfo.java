...
public class VkExportMemoryAllocateInfo extends Struct<VkExportMemoryAllocateInfo> implements NativeResource {
    ...
    public static VkExportMemoryAllocateInfo malloc() {
        return new VkExportMemoryAllocateInfo(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static VkExportMemoryAllocateInfo calloc() {
        return new VkExportMemoryAllocateInfo(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static VkExportMemoryAllocateInfo create() {
        ...
        return new VkExportMemoryAllocateInfo(memAddress(container), container);
    }
    ...
    public static @Nullable VkExportMemoryAllocateInfo createSafe(long address) {
        return address == NULL ? null : new VkExportMemoryAllocateInfo(address, null);
    }
    ...
    public static VkExportMemoryAllocateInfo.@Nullable Buffer createSafe(long address, int capacity) {
    ...
    public static VkExportMemoryAllocateInfo malloc(MemoryStack stack) {
        return new VkExportMemoryAllocateInfo(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static VkExportMemoryAllocateInfo calloc(MemoryStack stack) {
        return new VkExportMemoryAllocateInfo(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static int nsType(long struct) { return memGetInt(struct + VkExportMemoryAllocateInfo.STYPE); }
    ...
    public static int nhandleTypes(long struct) { return memGetInt(struct + VkExportMemoryAllocateInfo.HANDLETYPES); }

    /** Unsafe version of {@link #sType(int) sType}. */
    public static void nsType(long struct, int value) { memPutInt(struct + VkExportMemoryAllocateInfo.STYPE, value); }
    ...
    public static void nhandleTypes(long struct, int value) { memPutInt(struct + VkExportMemoryAllocateInfo.HANDLETYPES, value); }
    ...
    public static class Buffer extends StructBuffer<VkExportMemoryAllocateInfo, Buffer> implements NativeResource {
         ...
         * by {@link VkExportMemoryAllocateInfo#SIZEOF}, and its mark will be undefined.</p>
         *
