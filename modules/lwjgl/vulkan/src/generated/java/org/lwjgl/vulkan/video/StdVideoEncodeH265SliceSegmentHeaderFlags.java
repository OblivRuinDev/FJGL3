...
public class StdVideoEncodeH265SliceSegmentHeaderFlags extends Struct<StdVideoEncodeH265SliceSegmentHeaderFlags> implements NativeResource {
    ...
    static int nbitfield0(long struct) { return memGetInt(struct + StdVideoEncodeH265SliceSegmentHeaderFlags.BITFIELD0); }
    ...
    static int nbitfield1(long struct) { return memGetInt(struct + StdVideoEncodeH265SliceSegmentHeaderFlags.BITFIELD1); }
    static int nreserved(long struct) { return nbitfield1(struct) & 0x00_0F_FF_FF; }

    static void nbitfield0(long struct, int value) { memPutInt(struct + StdVideoEncodeH265SliceSegmentHeaderFlags.BITFIELD0, value); }
    ...
    static void nbitfield1(long struct, int value) { memPutInt(struct + StdVideoEncodeH265SliceSegmentHeaderFlags.BITFIELD1, value); }
    static void nreserved(long struct, int value) { nbitfield1(struct, (nbitfield1(struct) & 0xFF_F0_00_00) | (value & 0x00_0F_FF_FF)); }
