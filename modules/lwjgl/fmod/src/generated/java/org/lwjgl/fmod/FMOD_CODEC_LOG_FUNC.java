...
public abstract class FMOD_CODEC_LOG_FUNC extends Callback implements FMOD_CODEC_LOG_FUNCI {
     ...
     */
    public static FMOD_CODEC_LOG_FUNC create(long functionPointer) { return create(Callback.get(functionPointer), functionPointer); }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code functionPointer} is {@code NULL}. */
    public static @Nullable FMOD_CODEC_LOG_FUNC createSafe(long functionPointer) { return functionPointer == NULL ? null : create(functionPointer); }

    /** Creates a {@code FMOD_CODEC_LOG_FUNC} instance that delegates to the specified {@code FMOD_CODEC_LOG_FUNCI} instance. */
    public static FMOD_CODEC_LOG_FUNC create(FMOD_CODEC_LOG_FUNCI instance) { return create(instance, instance.address()); }

    private static FMOD_CODEC_LOG_FUNC create(FMOD_CODEC_LOG_FUNCI instance, long functionPointer) {
        return instance instanceof FMOD_CODEC_LOG_FUNC
            ? (FMOD_CODEC_LOG_FUNC)instance
            : new FMOD_CODEC_LOG_FUNC(functionPointer) {
