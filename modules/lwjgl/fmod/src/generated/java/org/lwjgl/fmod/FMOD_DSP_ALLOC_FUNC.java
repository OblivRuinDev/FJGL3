...
public abstract class FMOD_DSP_ALLOC_FUNC extends Callback implements FMOD_DSP_ALLOC_FUNCI {
     ...
     */
    public static FMOD_DSP_ALLOC_FUNC create(long functionPointer) { return create(Callback.get(functionPointer), functionPointer); }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code functionPointer} is {@code NULL}. */
    public static @Nullable FMOD_DSP_ALLOC_FUNC createSafe(long functionPointer) { return functionPointer == NULL ? null : create(functionPointer); }

    /** Creates a {@code FMOD_DSP_ALLOC_FUNC} instance that delegates to the specified {@code FMOD_DSP_ALLOC_FUNCI} instance. */
    public static FMOD_DSP_ALLOC_FUNC create(FMOD_DSP_ALLOC_FUNCI instance) { return create(instance, instance.address()); }

    private static FMOD_DSP_ALLOC_FUNC create(FMOD_DSP_ALLOC_FUNCI instance, long functionPointer) {
        return instance instanceof FMOD_DSP_ALLOC_FUNC
            ? (FMOD_DSP_ALLOC_FUNC)instance
            : new FMOD_DSP_ALLOC_FUNC(functionPointer) {
