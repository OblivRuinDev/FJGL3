...
public abstract class FMOD_DSP_REALLOC_FUNC extends Callback implements FMOD_DSP_REALLOC_FUNCI {
     ...
     */
    public static FMOD_DSP_REALLOC_FUNC create(long functionPointer) { return create(Callback.get(functionPointer), functionPointer); }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code functionPointer} is {@code NULL}. */
    public static @Nullable FMOD_DSP_REALLOC_FUNC createSafe(long functionPointer) { return functionPointer == NULL ? null : create(functionPointer); }

    /** Creates a {@code FMOD_DSP_REALLOC_FUNC} instance that delegates to the specified {@code FMOD_DSP_REALLOC_FUNCI} instance. */
    public static FMOD_DSP_REALLOC_FUNC create(FMOD_DSP_REALLOC_FUNCI instance) { return create(instance, instance.address()); }

    private static FMOD_DSP_REALLOC_FUNC create(FMOD_DSP_REALLOC_FUNCI instance, long functionPointer) {
        return instance instanceof FMOD_DSP_REALLOC_FUNC
            ? (FMOD_DSP_REALLOC_FUNC)instance
            : new FMOD_DSP_REALLOC_FUNC(functionPointer) {
