...
public interface FMOD_DSP_PAN_SUMSTEREOTOSURROUNDMATRIX_FUNCI extends CallbackI {
    ...
    Callback.Descriptor DESCRIPTOR = new Callback.Descriptor(
        FMOD_DSP_PAN_SUMSTEREOTOSURROUNDMATRIX_FUNCI.class,
    ...
    /** {@code FMOD_RESULT (* FMOD_DSP_PAN_SUMSTEREOTOSURROUNDMATRIX_FUNC) (struct FMOD_DSP_STATE * dsp_state, FMOD_SPEAKERMODE targetSpeakerMode, float direction, float extent, float rotation, float lowFrequencyGain, float overallGain, int matrixHop, float * matrix)} */
