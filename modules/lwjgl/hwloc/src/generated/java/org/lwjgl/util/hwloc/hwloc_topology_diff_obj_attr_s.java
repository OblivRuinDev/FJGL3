...
public class hwloc_topology_diff_obj_attr_s extends Struct<hwloc_topology_diff_obj_attr_s> {
    ...
    static {
        ...
        Layout layout = __struct(
            ...
            __member(4),
            __member(4),
            __member(hwloc_topology_diff_obj_attr_u.SIZEOF, hwloc_topology_diff_obj_attr_u.ALIGNOF)
        );
        ...
        DIFF = layout.offsetof(4);
    }

    public hwloc_topology_diff_obj_attr_s(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    /**
     * Creates a {@code hwloc_topology_diff_obj_attr_s} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    /** @return a {@link hwloc_topology_diff_obj_attr_u} view of the {@code diff} field. */
    @NativeType("struct hwloc_topology_diff_obj_attr_u")
    public hwloc_topology_diff_obj_attr_u diff() { return ndiff(address()); }

    // -----------------------------------

    /** Returns a new {@code hwloc_topology_diff_obj_attr_s} instance for the specified memory address. */
    public static hwloc_topology_diff_obj_attr_s create(long address) {
        return new hwloc_topology_diff_obj_attr_s(address, null);
    }
    ...
    /**
     * Create a {@link hwloc_topology_diff_obj_attr_s.Buffer} instance at the specified memory.
     *
     * @param address  the memory address
     * @param capacity the buffer capacity
     */
    public static hwloc_topology_diff_obj_attr_s.Buffer create(long address, int capacity) {
    ...
    /** An array of {@link hwloc_topology_diff_obj_attr_s} structs. */
    public static class Buffer extends StructBuffer<hwloc_topology_diff_obj_attr_s, Buffer> {

        private static final hwloc_topology_diff_obj_attr_s ELEMENT_FACTORY = hwloc_topology_diff_obj_attr_s.create(-1L);

        /**
         * Creates a new {@code hwloc_topology_diff_obj_attr_s.Buffer} instance backed by the specified container.
         *
         * <p>Changes to the container's content will be visible to the struct buffer instance and vice versa. The two buffers' position, limit, and mark values
         * will be independent. The new buffer's position will be zero, its capacity and its limit will be the number of bytes remaining in this buffer divided
         * by {@link hwloc_topology_diff_obj_attr_s#SIZEOF}, and its mark will be undefined.</p>
         *
        ...
        /** @return the value of the {@code obj_index} field. */
        @NativeType("unsigned int")
        public int obj_index() { return hwloc_topology_diff_obj_attr_s.nobj_index(address()); }
        /** @return a {@link hwloc_topology_diff_obj_attr_u} view of the {@code diff} field. */
        @NativeType("struct hwloc_topology_diff_obj_attr_u")
        public hwloc_topology_diff_obj_attr_u diff() { return hwloc_topology_diff_obj_attr_s.ndiff(address()); }
