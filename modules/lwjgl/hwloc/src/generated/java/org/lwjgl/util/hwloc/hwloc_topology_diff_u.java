...
public class hwloc_topology_diff_u extends Struct<hwloc_topology_diff_u> {
    ...
    public static @Nullable hwloc_topology_diff_u createSafe(long address) {
    ...
    public static hwloc_topology_diff_u.@Nullable Buffer createSafe(long address, int capacity) {
